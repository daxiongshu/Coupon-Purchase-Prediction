...
def getUserVisitFeatures(user_id, coupon_visit_dict, date_before_purchase_date):
	user_visit_features_header = ['no_visits_7days', 'no_visits_15days', 'no_visits_30days', 'no_visits_60days', 'no_visits_older']
	...
	user_visit_features = [no_visits_7days, no_visits_15days, no_visits_30days, no_visits_60days, no_visits_older]
