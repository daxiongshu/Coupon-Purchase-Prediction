...
if __name__ == "__main__":
	...
	train_X = np.array( train.drop(["COUPON_ID_hash", "USER_ID_hash", "DV"],axis=1))
	...
	################## XGBoost ###############
        ...
        params["eta"] = 0.02 #0.05 #0.05 #0.2 #0.2 #0.2
        params["min_child_weight"] = 18 #10 #18 #100 #18 #10
        params["subsample"] = 0.7
        params["colsample_bytree"] = 0.6
        params["scale_pos_weight"] = 0.8
        params["silent"] = 1
        params["max_depth"] = 14 #8 #14 #10 #14 #8
        params["max_delta_step"]=2
        params["seed"] = 0
        params['eval_metric'] = "auc"
	#num_rounds = #450 #400 #90 #350
	...
	for dev_index, val_index in kf:
		...
		xgtrain = xgb.DMatrix(train_X[dev_index,:], label=dev_y)
        	xgtest = xgb.DMatrix(train_X[val_index,:], label=val_y)
